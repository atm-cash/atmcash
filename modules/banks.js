...
function revolutEffectiveRate(baseRate) {
  // v5.3: Revolut estimeres ud fra Nationalbankens THB-grundkurs minus 0,95%.
  return baseRate * 0.9905;
}

function wiseEffectiveRate(baseRate) {
  // v5.3: Wise estimeres ud fra Nationalbankens THB-grundkurs minus 0,43%.
