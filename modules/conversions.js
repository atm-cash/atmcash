// ATM Cash v1.1 - conversions, defaults, config, language and currency helpers
let defaults = {
  ...
  tavex: { place: "Tavex webshop", rate: 4.81696, margin: 5.14, fixedDkk: 0, delivery: 50, other: 0 }
};
